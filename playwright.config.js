...
module.exports = defineConfig({
  ...
  reporter: [
    ['html', { outputFolder: 'playwright-report' }], // HTML dla lokalnego debugowania
    ['junit', { outputFile: 'results.xml' }],       // JUnit dla CI
  ],
  ...
  use: {
    ...
    httpCredentials: {
      username: 'betaAccessPlease',
      password: 'pHFRZ2y^azddWV'
    }
  },
